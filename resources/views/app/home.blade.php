        ...
        <div class="row">
            <div class="col">
                <article class="pcj-header-content">
                    ...
                    <p>I am a <b>Web Developer</b> from <b>Denmark</b> with a speciality in <b>PHP</b>, and I love to work with <a href="https://twitter.com/search?f=tweets&vertical=default&q=%23webdev%20AND%20from%3A%40tehwave" target="_blank" rel="noopener">#webdev</a> & <a href="https://twitter.com/search?f=tweets&vertical=default&q=%23gamedev%20AND%20from%3A%40tehwave" target="_blank" rel="noopener">#gamedev</a>.</p>
                </article>
            </div>
        </div>
    </div>
