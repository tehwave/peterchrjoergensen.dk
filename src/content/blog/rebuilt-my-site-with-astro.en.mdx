...
<RelatedPost
  ...
  lead="By the way,"
  prefix="I also wrote about"
  linkText="how I added comments with giscus"
  suffix="using GitHub Discussions instead of bringing a database or admin system back into the stack."
/>
...
<RelatedContent
  ...
  links={[
    ...
    { href: "/blog/localizing-this-website-without-changing-its-urls/", title: "How I Localized This Website Without Changing Existing URLs" },
    { href: "/blog/adding-comments-with-giscus/", title: "Adding Comments with giscus" },
  ]}
/>
