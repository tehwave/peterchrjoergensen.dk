...
title: "I built a browser multiplayer game without a server"
description: "I built a zero-server WebRTC air-hockey experiment with AI-assisted code. I did not know WebRTC beforehand, so the project became both a playable prototype and a practical way to learn peer-to-peer browser architecture."
category: "games"
...
<Wide>
	<Figure
		src={earlyMatchUi}
		alt="Early screenshot of the Browser Multiplayer match screen showing oversized win text, boxed score cards, and rough touch controls"
		caption="The first working match screen. The WebRTC part worked. The interface looked like it had lost a fight with a wireframe."
	/>
</Wide>
...
<Wide>
	<Figure
		...
		alt="Early screenshot of the Browser Multiplayer handshake screen showing stacked buttons, invite code generation, and rough mobile layout"
		caption="The first handshake UI during invite generation. Technically useful, visually guilty."
	/>
</Wide>
...
1. Write the plan.
2. Let the agent execute the technical slice.
3. Test the real thing, not the idea of the thing.
4. Notice what the plan forgot.
5. Iterate where taste matters.
6. Read the generated code until the architecture becomes yours.
7. Validate the repo before calling it done.
...
<RelatedContent
  heading="Read next"
  links={[
    { href: "/blog/quick-dirty-webrtc-manual-signaling/", title: "How WebRTC Lets Two Browsers Talk Without a Server" },
    { href: "/projects/github-brick-breaker/", title: "I turned my GitHub contributions into a playable brick breaker game" },
  ]}
/>
