...
<header class="container header text-center">
	...
	<nav class="row">
		...
		<section class="three columns">
			<a href="mailto:hello@peterchrjoergensen.dk?subject=Hello" target="_top" class="icon" title="Send me an email">
			...
			<a href="https://www.linkedin.com/in/peterchrjoergensen" target="_blank" rel="noopener" class="icon" title="Find me on LinkedIn">
			...
			<a href="https://www.twitter.com/tehwave" target="_blank" rel="noopener" class="icon" title="Find me on Twitter">
