			...
			<nav>
				<div class="row">
					...
					<section class="three columns">
						<a href="mailto:hello@peterchrjoergensen.dk?subject=Hello" target="_top" class="icon">
						...
						<a href="https://www.linkedin.com/in/peterchrjoergensen" target="_blank" rel="noopener" class="icon">
						...
						<a href="https://www.twitter.com/tehwave" target="_blank" rel="noopener" class="icon">
		...
		<main class="u-full-width">
			...
			<section class="parallax intro" data-parallax="scroll" data-speed="0.6" data-image-src="/img/home.jpg" data-natural-width="1920" data-natural-height="1080" data-z-index="0">
				<div class="container">
					...
					<p>I am a student of <b>Multimedia Design</b> in <b>Denmark</b> with a specialty in <b>Film & Animation</b>, and I like to work with <a href="https://twitter.com/search?f=tweets&vertical=default&q=%23webdev%20AND%20from%3A%40tehwave" target="_blank" rel="noopener" class="twitter-search">#webdev</a> & <a href="https://twitter.com/search?f=tweets&vertical=default&q=%23gamedev%20AND%20from%3A%40tehwave" target="_blank" rel="noopener" class="twitter-search">#gamedev</a> as a hobby.</p>
				</div>
			</section>
